...
from items.item_slot_set import ItemSlotSet, ItemSlotSetTypes

from actions.action_attack import ActionAttack
...
class Character:
    def __init__(self):
        ...
        self.equipped_items = ItemSlotSet(ItemSlotSetTypes.HUMAN)
        self.level = 1
        self.name = "Unnamed"

        # Add non level scaling base stats
        self.stats.add_stat(Stats.MIN_DAMAGE, 1)
        self.stats.add_stat(Stats.MAX_DAMAGE, 2)
        ...
        self.actions = []
        self.actions.append(ActionAttack(self))
    ...
    def get_max_health(self):
        return self.stats.get_stat(Stats.MAXIMUM_HEALTH)
